...
Как известно, дублирования кода всегда нужно избегать и было мы круто если бы и у нас была возможность вынести pointcut 
в отдельный блок и ссылаться на него сколько угодно раз. Благо такая возможность есть. Сделать это можно с помощью аннотации
`@Pointcut`, которая ставится над методом и принимает **pointcut expression** в качестве аргумента. Так же их можно комбинировать с помощью && || и !.
Давайте улучшим наш код:

    @Pointcut("execution(* mate.academy.springboot.aop.service.CategoryService.findAll())")
    public void findAllCategoryServiceMethod() {}
